      ...
      <main className="legal-page">
        <div className="legal-container">
          ...
          <section className="legal-section" id="s3">
            ...
            <p>Where local law requires a higher minimum age for any of the above activities, that local law applies. Libo may also restrict or block participation by jurisdiction (see Section 16, Governing Law) — entry is <em>void where prohibited by local law</em>.</p>
          </section>
